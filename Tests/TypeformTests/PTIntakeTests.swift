...
struct PTIntakeTests {
    ...
    @Test func lastFieldToThankYouScreen() throws {
        let responses: Responses = try [
            ...
            #require(Reference(uuidString: "49bbbbb5-b2db-4fe6-9257-2cea7a21159f")): .int(1),
            #require(Reference(uuidString: "8bad022d-fb6d-497c-a4c2-ade0ad99d696")): .int(1),
            ...
            #require(Reference(uuidString: "87249736-4231-4da0-b626-50c48dc91c27")): .choice(
                Choice(id: "CcH9VF3OO56t", ref: #require(Reference(uuidString: "4bc77e92-c70c-442b-aa87-09aac3df4eea")), label: "Nearly every day"),
            ),
            #require(Reference(uuidString: "c0dde0d4-0f31-45fd-ba13-d460ad13cb32")): .choice(
                Choice(id: "GQSWmGIq0f3k", ref: #require(Reference(uuidString: "a8ccca7e-37d2-409d-b52f-53f7e8aa8712")), label: "Not at all"),
            ),
            #require(Reference(uuidString: "ab1805b7-1cba-474c-aee3-1a2a17683b8c")): .int(1),
            #require(Reference(uuidString: "187a3247-605d-467d-9477-bc4e13c476b5")): .int(1),
            #require(Reference(uuidString: "ccc8ef20-2cbc-48e7-aaf5-512b5ba6cf88")): .int(1),
